...
/* ═══════════════════════════════════════════
   NAVBAR — logo compact, no overlap on scroll
═══════════════════════════════════════════ */
.navbar {{
...
/* Transparent text, show logo via ::before */
.navbar-brand {{
...
/* Fix sticky header secondary nav overlap — add top offset */
#page {{
    padding-top: 0 !important;
}}
/* Ensure secondary nav (breadcrumbs/page-header) doesn't clip under navbar */
...
/* Moodle Boost sticky navbar compensation */
body.has-region-main-actions-above,
body {{
    padding-top: 0 !important;
}}
