...
<!-- Последний прогон: 2026-03-26 02:00 BKK, 1957 screenshots, OK -->
...
- **Статус:** verified-fixed — Self-check: schoolNav=['Мои предметы','Расписание','Оценки','Сообщения'], primaryNavHidden=True
...
## BUG-052: Drawer оглавление — accordion/chevrons, обрезанный текст, CAPS LOCK
- **Страница:** /course/view.php, /course/section.php (все курсы)
- **Роль:** student
- **Ожидание:** Плоский список секций без accordion. Полные названия. Sentence case
- **Факт:** На скрине light_section_desktop — chevrons убраны, text-transform нормальный (sentence case), текст переносится
- **Скриншот:** screenshots/light_section_desktop.png
- **Статус:** verified-fixed (2026-03-26)
...
- **Статус:** verified-fixed — Self-check: capsCount=0, text-transform none
